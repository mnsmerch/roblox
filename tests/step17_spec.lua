...
--@INJECT WeatherConfig=src/ReplicatedStorage/SAD_Shared/Config/WeatherConfig.lua MutationConfig=src/ReplicatedStorage/SAD_Shared/Config/MutationConfig.lua RarityConfig=src/ReplicatedStorage/SAD_Shared/Config/RarityConfig.lua ZoneConfig=src/ReplicatedStorage/SAD_Shared/Config/ZoneConfig.lua RebirthConfig=src/ReplicatedStorage/SAD_Shared/Config/RebirthConfig.lua UpgradeConfig=src/ReplicatedStorage/SAD_Shared/Config/UpgradeConfig.lua GameConfig=src/ReplicatedStorage/SAD_Shared/Config/GameConfig.lua RNG=src/ReplicatedStorage/SAD_Shared/Modules/RNG.lua Format=src/ReplicatedStorage/SAD_Shared/Modules/Format.lua@
...
for name, mod in pairs({ WeatherConfig = WeatherConfig, MutationConfig = MutationConfig,
	...
	UpgradeConfig = UpgradeConfig, GameConfig = GameConfig }) do
